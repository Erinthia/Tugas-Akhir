    ...
    <div class="section-body">
        ...
        <div class="section-title-lead-wrapper">
            <div class="section-title">
                ...
                <h2 class="section-title-text">InterviewHR List</h2>
            </div>
            <p class="section-lead">
                In this section you can manage system InterviewHR data such as editing and show detail.
            </p>
        </div>
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <form action="{{ route('admin.interview_hr.index') }}" method="GET" id="searchForm">
                    ...
                    <tbody>
                        @foreach ($applicants as $index => $applicant)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.interview_hr.show', $applicant->id) }}"
                                        class="btn btn-icon btn-primary">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.interview_hr.edit', $applicant->id) }}"
                                ...
                                <td>
                                    <span class="badge bg-secondary text-dark">
                                        {{ $applicant->InterviewHR->decision->name ?? '-' }}
                                    </span>
                                </td>

...
@section('title', 'Edit Interview HR')

@section('content')
    <div class="section-header">
        <h1>Additional Information Interview HR</h1>
    </div>
    ...
    <div class="section-body">
        <div class="section-title-lead-wrapper">
            <div class="section-title">
                ...
                <h2 class="section-title-text">Information Interview HR</h2>
            </div>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <form action="{{ route('admin.interview_hr.sendCustomEmail', $applicant->id) }}" method="POST">
                    @csrf

...
@section('content')
    <div class="section-header">
        <h1>Additional Information Psikotest</h1>
    </div>
    ...
    <div class="section-body">
        <div class="section-title-lead-wrapper">
            <div class="section-title">
                ...
                <h2 class="section-title-text">Information Psikotest</h2>
            </div>
        ...
        <div class="card mt-4">
            <div class="card-body">
                <form action="{{ route('admin.psikotests.sendCustomEmail', $applicant->id) }}" method="POST">
                    @csrf

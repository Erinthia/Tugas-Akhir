        ...
        <div class="card" style="min-height: 900px;">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="score" value="{{ $psikotest->score }}" readonly>
                </div>
                <div class="form-group">
                    <label>Decision</label>
                    <input type="text" class="form-control" value="{{ $psikotest->decision->name ?? '-' }}" readonly>
                </div>
                <div class="form-group">
                    <label for="notes">Notes</label>
                    <textarea class="form-control" id="notes" style="height: 150px" readonly>{{ $psikotest->notes }}</textarea>
                </div>
                <div class="buttons">
